...
export default function Home() {
  ...
  return (
    <>
      <main className="p-4 sm:h-dvh flex flex-col gap-6 justify-center items-center">
        <section>
          <MotionDiv initial={{ opacity: 0, y: -10 }} transition={{ duration: 0.5, ease: "backIn" }} animate={{ opacity: 1, y: 0 }} className="text-5xl sm:text-6xl relative">
            <h1 className="text-5xl sm:text-6xl max-w-[600px] z-10 text-center">
              The fastest <span>chat, now with </span> <span className=" font-bold text-purple-700">AI</span>
            </h1>
            <MotionDiv
              initial={{ opacity: 0 }}
              ...
              animate={{ opacity: 1 }}
              id="scene-container"
              className="z-0 pt-5 sm:pt-0 pointer-events-none absolute -right-2 -bottom-14 sm:right-16 sm:-bottom-24 aspect-square h-[120px] sm:h-[180px] -rotate-90"
            >
              <Scene />
            </MotionDiv>
          </MotionDiv>
